...
using Oguzambalaj.Runner.Configuration;
using Oguzambalaj.Runner.SequenceAnalysis;
using Oguzambalaj.Runner.SumOfMultiple;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Logging;

namespace Oguzambalaj.Runner
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!endApp)
            {
                // kullanicidan soru scmesini istemek icin
